...
public class RealmHelper {
    ...
    public void setStartingPrsenter(StartingPrsenter startingPrsenter) {  //На данный момент у меня некоторые недопонмание RX - в данный момент тут не могу его применить, придется передать - экземпляр презентера
